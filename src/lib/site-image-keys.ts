...
export const SITE_IMAGE_KEYS: SiteImageKeyDef[] = [
  ...
  },
  {
    ...
    group: 'Homepage',
    label: 'Homepage Hero — Chapter 2',
    description: 'Cinematic hero, second chapter — worship, "Encounter God."',
    fallback: UNSPLASH_HERO_WORSHIP,
  },
  {
    key: 'home_hero_chapter_3',
    group: 'Homepage',
    label: 'Homepage Hero — Chapter 3',
    description: 'Cinematic hero, third chapter — worship band on stage, "Discover Purpose."',
    fallback: UNSPLASH_HERO_WORSHIP_BAND,
  },
  {
    key: 'home_hero_chapter_4',
    group: 'Homepage',
    label: 'Homepage Hero — Chapter 4',
    description: 'Cinematic hero, fourth chapter — small group in a prayer huddle, "Find Your Family."',
    fallback: UNSPLASH_HERO_SMALL_GROUP,
  },
  {
    key: 'home_hero_chapter_5',
    group: 'Homepage',
    label: 'Homepage Hero — Chapter 5',
    description: 'Cinematic hero, fifth and final chapter — fellowship at a stone archway, "Live a Higher Life."',
